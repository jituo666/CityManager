...
public class PictureHorizontalScrollview extends HorizontalScrollView {

    Context context;
    int prevIndex = 0;

    public PictureHorizontalScrollview(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setAdapter(Context context, PictureListAdapter mAdapter) {
        fillViewWithAdapter(mAdapter);
    }

    private void fillViewWithAdapter(PictureListAdapter mAdapter) {
